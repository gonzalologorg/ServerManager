namespace ServerManager
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			groupBox1.Controls.Add(screenModeCBox);
			...
			// screenModeCBox
			// 
			screenModeCBox.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			screenModeCBox.FormattingEnabled = true;
			screenModeCBox.Items.AddRange(new object[] { "window", "noborder", "fullscreen" });
			screenModeCBox.Location = new Point(652, 88);
			screenModeCBox.Name = "screenModeCBox";
			screenModeCBox.Size = new Size(80, 23);
			screenModeCBox.TabIndex = 13;
			screenModeCBox.Text = "window";
			screenModeCBox.SelectedIndexChanged += screenModeCBox_SelectedIndexChanged;
			// 
			// autoJoin
			// 
			autoJoin.Anchor = AnchorStyles.Top | AnchorStyles.Right;
			autoJoin.AutoSize = true;
			autoJoin.Location = new Point(468, 118);
			...
			clientArgs.Size = new Size(529, 23);
			...
			// resolutionBox
			// 
			resolutionBox.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
			...
			resolutionBox.Location = new Point(541, 88);
		...
		private ComboBox screenModeCBox;
	}
}